...
export const ShoppingCartProduct = () => {
    ...
    // }
    // }
    const convertPriceToNumber = (price, index) => {
        try {
            if (!price.startsWith('$')) {
                    ...
                    {shoppingCart.map((item, index) => {
                        ...
                        return (
                            <div>
                                        ...
                                        <div className='productDetails'>
                                            <div className='sizeAndEditContainer'>
                                                ...
                                                <button className='edit button'
                                                        onClick={() => handleEditPopUp(index)}>Edit
                                                </button>
                                            </div>
                                            <div className='productDetailsRight'>
                                                <div className='priceContainer'>
                                                    <div>Item Price</div>
                                                    <div>{convertPriceToNumber(item.price, index)}</div>
                                                </div>
                                ...
                                {isVisibleEdit[index] &&
                                    <EditPopUp product={item} key={index} closeOut={() => handleEditPopUp(index)}/>
                                }
                            </div>
                        )
                    })}
